...
export default function JobCard({ job, company }) {
  ...
  return (
    <Link href={'/jobs/' + job.slug}>
      <div className={'bg-white border border-pw-border rounded-xl p-4 sm:p-5 cursor-pointer transition-all hover:border-pw-green/40 hover:shadow-sm ' + (claimed ? 'border-l-[3px] border-l-pw-green' : '')}>
