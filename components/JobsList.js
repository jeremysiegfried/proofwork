...
export default function JobsList() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-6">
      ...
      <div className="flex flex-col sm:flex-row gap-2 mb-3">
        <div className="flex-1">
          ...
          <input value={query} onChange={function(e) { setQuery(e.target.value) }}
            ...
            className="w-full px-4 py-3 rounded-lg border border-pw-border bg-white text-sm text-pw-text1" />
        </div>
        <div className="flex-1">
      ...
      {/* Job Alert Banner */}
      <JobAlertBanner query={query} region={region} industry={industry} minSalary={minSalary} remoteFilter={remoteFilter} />
